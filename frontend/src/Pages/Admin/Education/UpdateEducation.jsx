...
const UpdateEducation = () => {
    ...
    return (
        ...
        <AdminHeader title={'Edit Education'}/>
        <div className={`flex flex-col justify-start w-full h-full max-md:w-[300px]
          rounded-lg mb-10
          overflow-y-auto
          ${theme==='dark'?'bg-black/80':'bg-white/40'}`}>
        <EditHeader title={'Education'} id={state?.itemData?._id}/>
        <EditCards data={state?.itemData} title={'Education'}/>
        </div>
